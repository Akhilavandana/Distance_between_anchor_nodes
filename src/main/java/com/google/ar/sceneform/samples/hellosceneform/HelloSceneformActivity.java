                ...
                (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
                    ...
                    if (btnLengthClicked) {
                        if (lastAnchorNode == null) {
                            ...
                            Pose pose = Pose.makeTranslation(0, 0.9f, 0).compose(hitResult.getHitPose());
                            ...
                            //transformableNode.getScaleController().setMinScale(0.8f);
                            //transformableNode.setLocalScale(new Vector3(0.25f, .25f, 0.05f));
                            transformableNode.setParent(anchorNode);
                            ...
                            // Create an ARCore Anchor at the position.
                            Pose pose = Pose.makeTranslation(0, 1.0f, 0).compose(hitResult.getHitPose());
